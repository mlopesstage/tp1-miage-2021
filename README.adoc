...
Cette méthode de définir les exigences métiers de l'application permet de simplifier les tests unitaires à effectuer sur les règles. Dans ce cas là, il suffit de faire passer un temps fictif en paramètre au lieu de l'objet et tester séparément son fonctionnement.
